...
$SADir = $uConfig['METABOX_SA_DIR']."/".$uConfig['METABOX_GD_NAME_'.$TDSearch.'']."/accounts";
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Title -->
        <h2 class="mt-4">Google Drive: <?=$uConfig['METABOX_GD_NAME_'.$TDSearch.'']?></h2> <small><a href="https://drive.google.com/drive/folders/<?=$uConfig['METABOX_GD_TD_'.$TDSearch.'']?>" class="btn btn-sm btn-primary" target="_blank">Team Drive: <?=$uConfig['METABOX_GD_TD_'.$TDSearch.'']?></a></small> <small><a href="https://console.developers.google.com/apis/credentials?project=<?=$uConfig['METABOX_GD_PROJECT_'.$TDSearch.'']?>" class="btn btn-sm btn-info" target="_blank">Project ID: <?=$uConfig['METABOX_GD_PROJECT_'.$TDSearch.'']?></a></small>
